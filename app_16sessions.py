...
from content_layout import select_controls_16sessions, controls_16sessions
    ...
    [
        ...
        dbc.Row(
            [dbc.Col(dcc.Graph(
                ...
                dbc.Col(controls_16sessions, width={"size": 3, "offset": 1}),
            ]
        ),
        dbc.Row(
            [dbc.Col(dcc.Graph(
                ...
                dbc.Col(select_controls_16sessions, width={"size": 3, "offset": 1 }), #"order": "last", "offset": 3
            ]
        ),
        dbc.Row(
            [dbc.Col(dcc.Graph(
...
@app.callback([Output('graph_0', 'figure'),
              ...
              [Input('upload_session_0', 'filename'),
               ...
               Input('upload_session_12', 'filename'),
               Input('upload_session_13', 'filename'),
               Input('upload_session_14', 'filename'),
               Input('upload_session_15', 'filename'),
               ...
               Input('graph_12', 'clickData'),
               Input('graph_13', 'clickData'),
               Input('graph_14', 'clickData'),
               Input('graph_15', 'clickData'),
              ...
              [State('graph_0', 'figure'),
               ...
               State('graph_12', 'figure'),
               State('graph_13', 'figure'),
               State('graph_14', 'figure'),
               State('graph_15', 'figure'),
               State('num_left_to_match', 'children')],
              prevent_initial_call=True)
def update_graphs(fn0, fn1, fn2, fn3, fn4, fn5, fn6, fn7, fn8, fn9, fn10, fn11, fn12, fn13, fn14, fn15,
                  cd0, cd1, cd2, cd3, cd4, cd5, cd6, cd7, cd8, cd9, cd10, cd11, cd12, cd13, cd14, cd15,
                  click_save, suggestion_mode, tiff_mode, no_match_update,
                  st0, st1, st2, st3, st4, st5, st6, st7, st8, st9, st10, st11, st12, st13, st14, st15,
                  state_cells_left):
    fnames = [fn0, fn1, fn2, fn3, fn4, fn5, fn6, fn7, fn8, fn9, fn10, fn11, fn12, fn13, fn14, fn15]
    cdata = [cd0, cd1, cd2, cd3, cd4, cd5, cd6, cd7, cd8, cd9, cd10, cd11, cd12, cd13, cd14, cd15]
    states = [st0, st1, st2, st3, st4, st5, st6, st7, st8, st9, st10, st11, st12, st13, st14, st15]
...
@app.callback(
    [Output('no_match_2', 'active'), Output('no_match_3', 'active'), Output('no_match_4', 'active'),
     ...
     Output('no_match_10', 'active'), Output('no_match_11', 'active'),
     Output('no_match_12', 'active'), Output('no_match_13', 'active'), Output('no_match_14', 'active'),
     Output('no_match_15', 'active'), Output('no_match_16', 'active'), Output('no_match_update_graph', 'children')],
    [Input('no_match_2', 'n_clicks'), Input('no_match_3', 'n_clicks'), Input('no_match_4', 'n_clicks'),
     ...
     Input('no_match_10', 'n_clicks'), Input('no_match_11', 'n_clicks'),
     Input('no_match_12', 'n_clicks'), Input('no_match_13', 'n_clicks'), Input('no_match_14', 'n_clicks'),
     Input('no_match_15', 'n_clicks'), Input('no_match_16', 'n_clicks'),
    ...
    [State('no_match_2', 'active'), State('no_match_3', 'active'),
     ...
     State('no_match_7', 'active'), State('no_match_8', 'active'),
     State('no_match_9', 'active'), State('no_match_10', 'active'), State('no_match_11', 'active'),
     State('no_match_12', 'active'), State('no_match_13', 'active'),
     State('no_match_14', 'active'), State('no_match_15', 'active'), State('no_match_16', 'active')
     ],
    prevent_initial_call=True)
def update_no_match_buttons(click2, click3, click4, click5, click6,
                            click7, click8, click9, click10, click11,
                            click12, click13, click14, click15, click16, reset,
